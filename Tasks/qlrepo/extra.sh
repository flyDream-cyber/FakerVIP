...
CR2(){
    ...
    ql repo https://github.com/flyDream-cyber/FakerBack3.git "jd_|jx_|gua_|jddj_|getJDCookie" "activity|backUp|Coupon|update" "^jd[^_]|USER|utils|^JS|^TS|^JDJRValidator_|^ZooFaker|^sign|ql|sentNotify|JDSignValidator" "main"
}
CR3(){
